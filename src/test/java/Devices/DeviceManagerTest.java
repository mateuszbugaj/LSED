...
//        deviceManager.update(new UserMessage(UserManager.getUser("User1"), "!dev1 com1 10", new Date()));
//        deviceManager.update(new UserMessage(UserManager.getUser("User1"), "!1 com1 10", new Date()));
//
...
//
//        deviceManager.addDevice(externalDevice);
//        deviceManager.update(new UserMessage(UserManager.getUser("User1"), "!dev2 com1 10", new Date()));
//        deviceManager.update(new UserMessage(UserManager.getUser("User1"), "!dev1 com2 10", new Date()));
//
